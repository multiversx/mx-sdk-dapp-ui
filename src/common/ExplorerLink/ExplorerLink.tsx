...
interface ExplorerLinkPropsType {
    ...
    dataTestId?: string;
    link: string;
    hasHostElement?: HTMLElement;
}

export function ExplorerLink({ class: className, iconClass, dataTestId, link, hasHostElement }: ExplorerLinkPropsType, children?: JSX.Element) {
    if (!link) {
        return null;
    }
