...
export const CircleCheckIcon = (properties: JSXBase.IntrinsicElements['svg']) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640" width="20" height="20" {...properties}>
    <path
      fill="currentColor"
