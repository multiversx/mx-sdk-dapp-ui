...
export const ArrowUpRightIcon = (properties: JSXBase.IntrinsicElements['svg']) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 10 10" width="12" height="12" {...properties}>
    <path
      fill="currentColor"
