...
@Component({
  tag: 'mvx-single-angle-up-icon',
  styleUrl: 'single-angle-up-icon.scss',
  shadow: false,
})
export class SingleAngleUpIcon {
  @Prop() class?: string;
  ...
  render() {
    return (
      <svg
        ...
        viewBox="0 0 640 640"
        class={{ 'single-angle-up-icon': true, [this.class]: Boolean(this.class) }}
      >
