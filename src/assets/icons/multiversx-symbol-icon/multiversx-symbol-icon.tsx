...
interface MultiversXSymbolIconPropsType {
  class?: string;
}

export function MultiversXSymbolIcon({ class: className }: MultiversXSymbolIconPropsType) {
  return (
    <svg
      viewBox="0 0 33 24"
      xmlns="http://www.w3.org/2000/svg"
      class={{ 'multiversx-symbol-icon': true, [className]: Boolean(className) }}
      style={{ width: '0.75rem', height: '0.75rem', fill: 'currentColor', flexShrink: '0' }}
    >
