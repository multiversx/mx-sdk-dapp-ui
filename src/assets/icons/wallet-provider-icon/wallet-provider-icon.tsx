...
interface WalletProviderIconPropsType {
  class?: string;
}

export function WalletProviderIcon({ class: className }: WalletProviderIconPropsType) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 40 40"
      class={{ 'wallet-provider-icon': true, [className]: Boolean(className) }}
      style={{ fill: 'none', width: '100%', height: '100%', maxWidth: '9.375rem', maxHeight: '9.375rem' }}
    >
