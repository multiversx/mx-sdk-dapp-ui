...
declare global {
  ...
  interface HTMLMvxLedgerAddressesElement extends Components.MvxLedgerAddresses, HTMLStencilElement {
    addEventListener<K extends keyof HTMLMvxLedgerAddressesElementEventMap>(
      type: K,
      listener: (
        this: HTMLMvxLedgerAddressesElement,
        ev: MvxLedgerAddressesCustomEvent<HTMLMvxLedgerAddressesElementEventMap[K]>,
      ) => any,
      options?: boolean | AddEventListenerOptions,
    ): void;
    addEventListener<K extends keyof DocumentEventMap>(
    ...
    removeEventListener<K extends keyof HTMLMvxLedgerAddressesElementEventMap>(
      type: K,
      listener: (
        this: HTMLMvxLedgerAddressesElement,
        ev: MvxLedgerAddressesCustomEvent<HTMLMvxLedgerAddressesElementEventMap[K]>,
