...
import {
  ...
  TransactionRowType,
} from './components/controlled/transactions-table/transactions-table.type';
...
declare global {
  ...
  interface HTMLMvxArrowUpRightFromSquareIconElement
    extends Components.MvxArrowUpRightFromSquareIcon,
      HTMLStencilElement {}
  ...
  interface HTMLMvxProviderIdleScreenElement extends Components.MvxProviderIdleScreen, HTMLStencilElement {
    addEventListener<K extends keyof HTMLMvxProviderIdleScreenElementEventMap>(
      type: K,
      listener: (
        this: HTMLMvxProviderIdleScreenElement,
        ev: MvxProviderIdleScreenCustomEvent<HTMLMvxProviderIdleScreenElementEventMap[K]>,
      ) => any,
      options?: boolean | AddEventListenerOptions,
    ): void;
    addEventListener<K extends keyof DocumentEventMap>(
    ...
    removeEventListener<K extends keyof HTMLMvxProviderIdleScreenElementEventMap>(
      type: K,
      listener: (
        this: HTMLMvxProviderIdleScreenElement,
        ev: MvxProviderIdleScreenCustomEvent<HTMLMvxProviderIdleScreenElementEventMap[K]>,
  ...
  interface HTMLMvxTransactionDirectionBadgeElement
    extends Components.MvxTransactionDirectionBadge,
      HTMLStencilElement {}
...
declare module '@stencil/core' {
  export namespace JSX {
    interface IntrinsicElements {
      ...
      'mvx-arrow-up-right-from-square-icon': LocalJSX.MvxArrowUpRightFromSquareIcon &
        JSXBase.HTMLAttributes<HTMLMvxArrowUpRightFromSquareIconElement>;
      ...
      'mvx-circle-exclamation-icon': LocalJSX.MvxCircleExclamationIcon &
        JSXBase.HTMLAttributes<HTMLMvxCircleExclamationIconElement>;
      ...
      'mvx-provider-idle-screen': LocalJSX.MvxProviderIdleScreen &
        JSXBase.HTMLAttributes<HTMLMvxProviderIdleScreenElement>;
      ...
      'mvx-single-angle-down-icon': LocalJSX.MvxSingleAngleDownIcon &
        JSXBase.HTMLAttributes<HTMLMvxSingleAngleDownIconElement>;
      'mvx-single-angle-left-icon': LocalJSX.MvxSingleAngleLeftIcon &
        JSXBase.HTMLAttributes<HTMLMvxSingleAngleLeftIconElement>;
      'mvx-single-angle-right-icon': LocalJSX.MvxSingleAngleRightIcon &
        JSXBase.HTMLAttributes<HTMLMvxSingleAngleRightIconElement>;
      ...
      'mvx-transaction-account': LocalJSX.MvxTransactionAccount &
        JSXBase.HTMLAttributes<HTMLMvxTransactionAccountElement>;
      'mvx-transaction-account-name': LocalJSX.MvxTransactionAccountName &
        JSXBase.HTMLAttributes<HTMLMvxTransactionAccountNameElement>;
      'mvx-transaction-age': LocalJSX.MvxTransactionAge & JSXBase.HTMLAttributes<HTMLMvxTransactionAgeElement>;
      'mvx-transaction-asset-icon': LocalJSX.MvxTransactionAssetIcon &
        JSXBase.HTMLAttributes<HTMLMvxTransactionAssetIconElement>;
      'mvx-transaction-direction-badge': LocalJSX.MvxTransactionDirectionBadge &
        JSXBase.HTMLAttributes<HTMLMvxTransactionDirectionBadgeElement>;
      ...
      'mvx-triangular-warning-icon': LocalJSX.MvxTriangularWarningIcon &
        JSXBase.HTMLAttributes<HTMLMvxTriangularWarningIconElement>;
      ...
      'mvx-xalias-provider-icon': LocalJSX.MvxXaliasProviderIcon &
        JSXBase.HTMLAttributes<HTMLMvxXaliasProviderIconElement>;
