...
export class TransactionToastDetails {
  ...
  private readonly showMoreTransactions = () => {
  ...
  render() {
    ...
    return (
      <div class="transaction-details-container">
        <div class="transaction-details-status" onClick={this.toggleExpand}>
          <mvx-fa-icon
            icon={faChevronDown}
        ...
        >
          ...
          {hasMoreTransactionsToShow && !this.showAllTransactions && (
            <div class="view-all-container">
              <button type="button" class="show-more-button" onClick={this.showMoreTransactions}>
