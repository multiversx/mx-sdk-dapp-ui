...
export default {
    ...
    transactionsTableBodyRow: 'transactions-table-body-row mvx:text-label mvx:border-b mvx:border-outline-variant',
    transactionsTableBodyCell: 'transactions-table-body-cell mvx:p-4 mvx:w-max',
    transactionsTableBodyCellChild: 'transactions-table-body-cell-child mvx:flex mvx:w-max'
