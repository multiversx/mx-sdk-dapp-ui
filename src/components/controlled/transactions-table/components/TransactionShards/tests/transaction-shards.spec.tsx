  ...
  it('renders with default props', async () => {
    ...
    expect(page.root).toEqualHtml(`
      <div class="mvx:fill-label mvx:flex mvx:gap-2 mvx:items-center mvx:w-max transaction-shards">
        ...
        <svg class="arrow-right-icon mvx:h-4 mvx:w-4 transaction-shards-arrow-icon" viewBox="0 0 448 512" xmlns="http://www.w3.org/2000/svg" style="width: 1rem; height: 1rem; flex-shrink: 0;">
