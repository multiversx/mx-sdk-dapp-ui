...
describe('transaction-method', () => {
  ...
  describe('rendering', () => {
    ...
    it('has correct data-testid', async () => {
      ...
      const spanElement = page.root.shadowRoot.querySelector(`[data-testid="${DataTestIdsEnum.method}"]`);
  ...
  describe('method display', () => {
    it('displays the transaction method', async () => {
      ...
      const methodElement = page.root.shadowRoot.querySelector('.text-truncate');
  ...
  describe('styling', () => {
    it('applies correct CSS classes to outer span', async () => {
      ...
      const outerSpan = page.root.shadowRoot.querySelector('span');
    ...
    it('applies correct CSS classes to inner div', async () => {
      ...
      const innerDiv = page.root.shadowRoot.querySelector('div > div');
