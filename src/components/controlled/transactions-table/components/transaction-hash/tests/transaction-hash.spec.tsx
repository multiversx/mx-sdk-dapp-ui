    ...
    expect(page.root).toEqualHtml(`
      <mvx-transaction-hash>
          <div class="transaction-hash">
            ...
            <mvx-explorer-link class="mvx:text-primary!" dataTestId="${DataTestIdsEnum.transactionLink}" link="https://example.com/tx/123"><span>0x123456789abcdef</span></mvx-explorer-link>
          </div>
      </mvx-transaction-hash>
    `);
  });
  ...
  it('updates when transaction prop changes', async () => {
    ...
    expect(page.root).toEqualHtml(`
      <mvx-transaction-hash>
          <div class="transaction-hash">
            <mvx-transaction-icon></mvx-transaction-icon>
            <mvx-explorer-link class="mvx:text-primary!" dataTestId="${DataTestIdsEnum.transactionLink}" link="https://example.com/tx/initial"><span>0xInitialHash</span></mvx-explorer-link>
          </div>
      </mvx-transaction-hash>
    `);
    ...
    expect(page.root).toEqualHtml(`
      <mvx-transaction-hash>
          <div class="transaction-hash">
            <mvx-transaction-icon></mvx-transaction-icon>
            <mvx-explorer-link class="mvx:text-primary!" dataTestId="${DataTestIdsEnum.transactionLink}" link="https://example.com/tx/updated"><span>0xUpdatedHash</span></mvx-explorer-link>
          </div>
      </mvx-transaction-hash>
    `);
  });
