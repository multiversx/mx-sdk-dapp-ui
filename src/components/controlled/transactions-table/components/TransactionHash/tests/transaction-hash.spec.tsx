  ...
  it('renders with transaction data', async () => {
    ...
    expect(page.root).toEqualHtml(`
      <div class="mvx:flex mvx:gap-1 mvx:items-center mvx:justify-center transaction-hash">
        ...
        <mvx-explorer-link class="mvx:text-primary! transaction-hash-explorer-link" dataTestId="${DataTestIdsEnum.transactionLink}" link="https://example.com/tx/123">
          <div class="mvx:flex mvx:max-w-full mvx:overflow-hidden mvx:relative mvx:whitespace-nowrap trim" data-testid="${DataTestIdsEnum.trim}">
  ...
  it('updates when transaction prop changes', async () => {
    ...
    expect(page.root).toEqualHtml(`
      ...
      <svg class="mvx:flex mvx:items-center mvx:justify-center transaction-hash-icon" height="20" viewBox="0 0 640 640" width="20" xmlns="http://www.w3.org/2000/svg">
        ...
        <mvx-explorer-link class="mvx:text-primary! transaction-hash-explorer-link" dataTestId="${DataTestIdsEnum.transactionLink}" link="https://example.com/tx/initial">
          <div class="mvx:flex mvx:max-w-full mvx:overflow-hidden mvx:relative mvx:whitespace-nowrap trim" data-testid="${DataTestIdsEnum.trim}">
            <div class="mvx:!text-inherit mvx:absolute mvx:leading-5 mvx:relative mvx:text-transparent trim-full trim-full-visible" data-testid="${DataTestIdsEnum.trimFullAddress}">
              0xInitialHash
            </div>
  ...
  it('renders with updated transaction data', async () => {
    ...
    expect(page.root).toEqualHtml(`
      <div class="mvx:flex mvx:gap-1 mvx:items-center mvx:justify-center transaction-hash">
        ...
        <mvx-explorer-link class="mvx:text-primary! transaction-hash-explorer-link" dataTestId="${DataTestIdsEnum.transactionLink}" link="https://example.com/tx/updated">
          <div class="mvx:flex mvx:max-w-full mvx:overflow-hidden mvx:relative mvx:whitespace-nowrap trim" data-testid="${DataTestIdsEnum.trim}">
            <div class="mvx:!text-inherit mvx:absolute mvx:leading-5 mvx:relative mvx:text-transparent trim-full trim-full-visible" data-testid="${DataTestIdsEnum.trimFullAddress}">
              0xUpdatedHash
            </div>
