...
import { MvxTransactionShards } from '../mvx-transaction-shards';

describe('TransactionShards', () => {
  const createMockTransaction = (senderShard: string, receiverShard: string): IMvxTransactionsTableRow => ({
  ...
  it('renders with default props', async () => {
    ...
    const page = await newSpecPage({
      components: [MvxTransactionShards],
