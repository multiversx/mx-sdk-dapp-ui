...
import type { IMvxTransactionAccount } from '../../../mvx-transactions-table.type';
import { MvxTransactionAccount } from '../mvx-transaction-account';

describe('TransactionAccount Component', () => {
  const baseAccount: IMvxTransactionAccount = {
  ...
  it('should render basic account information', async () => {
    const page = await newSpecPage({
      components: [MvxTransactionAccount],
  ...
  it('should render locked account icon when showLockedAccounts is true and account is locked', async () => {
    const lockedAccount: IMvxTransactionAccount = { ...baseAccount, isTokenLocked: true };
  ...
  it('should render contract icon when account is a contract', async () => {
    const contractAccount: IMvxTransactionAccount = { ...baseAccount, isContract: true };
  ...
  it('should render explorer link when showLink is true', async () => {
    const linkedAccount: IMvxTransactionAccount = { ...baseAccount, showLink: true };
