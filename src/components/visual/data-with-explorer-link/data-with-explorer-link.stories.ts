  ...
  render: properties => html`
    <div class="${styles.dataWithExplorerLinkStoriesWrapper}">
      <mvx-data-with-explorer-link
        ...
        explorerLink="${properties.explorerLink}"
        ?showCopyButton=${properties.showCopyButton}
        ?showExplorerButton=${properties.showExplorerButton}
        ?withTooltip=${properties.withTooltip}
  ...
  render: () => html`
    <div class="${styles.dataWithExplorerLinkStoriesWrapper}">
      <div class="${classNames(styles.dataWithExplorerLinkStoriesContainer, styles.dataWithExplorerLinkStoriesMedium)}">
        ...
        <mvx-data-with-explorer-link data="EGLD" explorerLink="${DEVNET_EXPLORER_URL}/tokens/EGLD"></mvx-data-with-explorer-link>
      </div>

      <div class="${classNames(styles.dataWithExplorerLinkStoriesContainer, styles.dataWithExplorerLinkStoriesMedium)}">
        <strong>Medium Data:</strong>
        <mvx-data-with-explorer-link data="USDC-c76f1f" explorerLink="${DEVNET_EXPLORER_URL}/tokens/USDC-c76f1f"></mvx-data-with-explorer-link>
      </div>
      ...
      <div class="${classNames(styles.dataWithExplorerLinkStoriesContainer, styles.dataWithExplorerLinkStoriesMedium)}">
        ...
        <mvx-data-with-explorer-link data="X" explorerLink="${DEVNET_EXPLORER_URL}/search/X"></mvx-data-with-explorer-link>
      </div>
    </div>
  `,
};
  ...
  render: () => html`
    <div class="${styles.dataWithExplorerLinkStoriesWrapper}">
      ...
      <div class="${classNames(styles.dataWithExplorerLinkStoriesContainer, styles.dataWithExplorerLinkStoriesNarrow)}">
        ...
        <mvx-data-with-explorer-link
          data="🚀🌟💎⚡🔥🌈✨💫🎯🎨"
          explorerLink="${DEVNET_EXPLORER_URL}/search/emoji"
        ></mvx-data-with-explorer-link>
      </div>
