...
// prettier-ignore
const styles = {
  trimStoriesWrapper: 'trim-stories-wrapper mvx:flex mvx:flex-wrap mvx:gap-6',
  ...
  trimStoriesNarrow: 'trim-stories-narrow mvx:w-32',
  ...
  trimStoriesExtraLargeFont: 'trim-stories-extra-large-font mvx:text-xl',
  trimStoriesMonospace: 'trim-stories-monospace mvx:font-mono',
  trimStoriesBackground: 'trim-stories-background mvx:bg-gray-100 mvx:p-2 mvx:rounded',
...
export const ContainerWidths: StoryObj<Trim> = {
  render: () => (
    <div class={styles.trimStoriesWrapper}>
      ...
      <div class={`${styles.trimStoriesContainer} ${styles.trimStoriesExtraWide}`}>
