...
export default {
    ...
    transactionDetailsInfoTextSpan: 'transaction-details-info-text-span mvx:text-sm mvx:font-medium mvx:leading-4 mvx:tracking-tight mvx:text-label',
    transactionDetailsInfoIcon: 'transaction-details-info-icon mvx:rounded-full mvx:w-4 mvx:h-4',
    transactionDetailsInfoIconImg: 'transaction-details-info-icon-img mvx:rounded-full mvx:w-4 mvx:h-4',
    ...
    transactionAmountPositive: 'transaction-amount-positive mvx:text-succes',
