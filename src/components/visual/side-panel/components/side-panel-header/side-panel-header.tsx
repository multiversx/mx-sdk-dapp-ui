...
export class SidePanelHeader {
  ...
  private readonly handleRightIconClick = (event: MouseEvent) => {
    event.preventDefault();
    this.rightButtonClick.emit();
  };

  private readonly handleLeftIconClick = (event: MouseEvent) => {
    event.preventDefault();
  ...
  render() {
    return (
      <div class="side-panel-heading">
        {this.hasLeftButton && (
          <div
            class={{ 'side-panel-heading-left': true, 'no-margin': !this.hasRightButton }}
        ...
        <div class={{ 'side-panel-heading-title': true, 'center': this.hasLeftButton && !this.hasRightButton }}>
          {this.panelTitle}
        </div>

        {this.hasRightButton && (
          <div class="side-panel-heading-right" onClick={this.handleRightIconClick}>
