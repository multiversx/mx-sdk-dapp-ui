...
export const Sizes: StoryObj<ExplorerLink> = {
  render: () => (
    <div class={styles.explorerStoriesGrid}>
      <mvx-explorer-link link={DEVNET_EXPLORER_URL} iconClass={styles.explorerStoriesIconSmall} />
      <mvx-explorer-link link={DEVNET_EXPLORER_URL} iconClass={styles.explorerStoriesIconDefault} />
      <mvx-explorer-link link={DEVNET_EXPLORER_URL} iconClass={styles.explorerStoriesIconLarge} />
      <mvx-explorer-link link={DEVNET_EXPLORER_URL} iconClass={styles.explorerStoriesIconExtraLarge} />
      <mvx-explorer-link link={DEVNET_EXPLORER_URL} iconClass={styles.explorerStoriesIconHuge} />
    </div>
  ),
};
...
export const Colors: StoryObj<ExplorerLink> = {
  render: () => (
    <div class={styles.explorerStoriesGrid}>
      <mvx-explorer-link link={DEVNET_EXPLORER_URL} iconClass={styles.explorerStoriesIconBlue} />
      <mvx-explorer-link link={DEVNET_EXPLORER_URL} iconClass={styles.explorerStoriesIconGreen} />
      <mvx-explorer-link link={DEVNET_EXPLORER_URL} iconClass={styles.explorerStoriesIconRed} />
      <mvx-explorer-link link={DEVNET_EXPLORER_URL} iconClass={styles.explorerStoriesIconPurple} />
      <mvx-explorer-link link={DEVNET_EXPLORER_URL} iconClass={styles.explorerStoriesIconOrange} />
    </div>
  ),
};
...
export const ButtonStyles: StoryObj<ExplorerLink> = {
  render: () => (
    <div class={styles.explorerStoriesGrid}>
      <mvx-explorer-link link={DEVNET_EXPLORER_URL} iconClass={styles.explorerStoriesButtonDefault} />
